...
const isOwner = [`${setting.ownerNumber}`,"6283125837776@s.whatsapp.net","6283125837776@s.whatsapp.net"].includes(sender) ? true : false
...
if (satu == "code"){ return db_user[x1].seri }
...
const gurbot = '6283125837776@s.whatsapp.net'
var footer_nya =`idin bot whatsapp kece`
var menu_nya =`${listmenu(sender,prefix,ad,namenya,premnya,usernya,romnya,tanggal,jam,no)}`
let btn_menu = [
{buttonId: `${prefix}groupbot`, buttonText: { displayText: 'JOIN GRUP BOT' }, type: 1 },
{buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER BOT' }, type: 1 },
{buttonId: `${prefix}rules`, buttonText: { displayText: 'PERINGATAN' }, type: 1 }
]
var but_menu = {
text: menu_nya,
footer: footer_nya,
...
case 'sc': case 'script':{
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
let text_buysc =`*_mohon maaf._*

• VITUR INI DI TUTUP SEMENTARA`
...
var bg_yoshii = '6283125837776@s.whatsapp.net'
conn.sendMessage(bg_yoshii, {text: teks + teks1, mentions:[sender]}, {quoted:msg})
...
conn.sendMessage(from, { caption: cap, image: { url: feta.data.qris }, buttons: buto, footer: '© created by yoshibotz' })
}
console.log(feta)
}
break
...
.then(data => {
var opt = { packname: 'YOSHID', author: 'By yoshii' }
...
var dev = '6283125837776@s.whatsapp.net'
